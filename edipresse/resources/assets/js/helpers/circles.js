...
(function(root, factory) {
  ...
  var requestAnimFrame =
    ...
    Circles = function(options) {
      ...
      this._maxValClass =
        options.maxValueStrokeClass || "circles-maxValueStroke";
  ...
  Circles.prototype = {
    ...
    _setPercentage: function(percentage) {
      ...
      this._textContainer.innerHTML = this._getText(
        this.getValueFromPercent(percentage)
      );
    },
    ...
    _getText: function(value) {
      ...
      return typeof this._text === "function"
        ? this._text.call(this, value)
        : this._text;
    },
    ...
    _generateSvg: function() {
      ...
      this._generatePath(
        ...
        this._colors[0],
        this._maxValClass
      )._generatePath(1, true, this._colors[1], this._valClass);
